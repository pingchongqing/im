<template xmlns:v-bind="http://www.w3.org/1999/xhtml">
  <div v-if="dingdan">
    ...
    <div class="mt-100 bg-fff" @click="dropDrow_hide">
      ...
      <div class="border-bottom p-sp bg-fff">
        <a href="javascript:void(0)">
          <div class="clearfix">
            <span class="fl f32 color-010101">{{titles}}</span>
            <b class="fr f32 color-f75e46">{{unit_num}}元</b>
          </div>
          <div class="clearfix mt-25">
            <div class="fl f28 color-010101">
              <span class="color-888 mr-20">单价</span>{{unit_addition}}
            </div>
            <div class="fr">
              ...
              <i v-if="icon_yi" @click="click_tishi4" class="icon-yitoubao icon fl mr-20"></i>
    ...
    <div class="box2 border-bottom" v-if="coinsBuy" @click="click_hint">
      <div class="line py-10">
        <span class="f28 color-999">友情提示</span>
        <i class="f32 color-000 fr spot"></i>
        <i class="f32 color-000 fr spot"></i>
        <i class="f32 color-000 fr spot"></i>
      </div>
    </div>
    ...
    <div class="axm-box mt-20 border-top border-bottom"  v-if="baoxian" >
    ...
    <div class="axm-box mt-20 border-top border-bottom" v-if="anxinmai">
      <span class="f32 ml-30 color-000 fl mr-20">卖家安心买</span>
      <i @click="coins_server" class="axm-tip fl"></i>
    </div>

    <div class="axm-box mt-20 border-top border-bottom" v-if="seller">
    ...
    <div class="order-submit bg-fff clearfix border-top fixed-bottom" style="z-index: 40">
      ...
      <div class="fr w50">
        <a class="submit text-center color-fff f32" @click="getSwitch" v-if="dingdan=='提交订单'">{{dingdan}}</a>
        <a class="submit_no text-center color-fff f30"  v-else-if="dingdan=='您不能购买自己的商品'">{{dingdan}}</a>
        <a class="submit_no text-center color-fff f30"  v-else-if="dingdan=='卖家不在线'">{{dingdan}}</a>
    ...
    <coins-form :url="isTest" v-on:total="total" v-on:formjuese="formjuese" v-on:formRoleName="formRoleName" v-on:formDengji="formDengji"
                ...
                v-on:formQqname="formQqname" v-on:formPhoneName="formPhoneName" ref="child_coins"
    ...
    <transition name="fade_sx">
      <div class="fadeUp border-top friendly-tip bg-fff" v-if="hint_box">
        ...
        <div class="p-30">
          <ul>
            <!--<li class="f30 color-666" v-html="hint_txt1"></li>-->
            <!--<li class="f30 color-666">1.由于魔兽世界游戏币交易的特殊性，建议您下线前使用完所购买的游戏币。</li>-->
            <!--<li class="f30 color-666">2.任何一个以黑货或者其他理由取回交易商品的人都是骗子，谨防被骗。</li>-->
            <!--<li class="f30 color-666">为快速交易，请您支付后及时加接手客服QQ进行交易，感谢您的配合。</li>-->
            <li class="f30 color-666" v-for="list in spstr">{{list.replace(/<\/?.+?>/g,"").replace(/&nbsp;/g,"")}}</li>
            <!--<li class="f30 color-666">{{hint_txt2}}</li>-->
            <!--<li class="f30 color-666">{{hint_txt3}}</li>-->
            <!--<li class="f30 color-666">{{hint_txt4}}</li>-->
    ...
    <dialog-serverbox v-if="dialog_server" :serverTitle="serverMessage">
      ...
      <div v-if="coinsServer === '卖家安心买'">
        <p class="f32 pt-40 pb-40 text-center color-000">卖家安心买</p>
      ...
      <div v-if="coinsServer === '商品保障险'">
        ...
        <ul>
          ...
          <li class="f30 color-666 border-bottom pb-40">2、购买后出现商品被回收、被找回、被封号，最高可赔付您所购买的订单金额。购买前请您仔细阅读
...
<script>
  ...
  import CoinsForm from "./CoinsForm2.vue"
  ...
  export default{
    ...
    data() {
      return {
        unit_num:this.$route.query.unit_num,
        unit_addition:this.$route.query.unit_addition.split('_')[0],
        blancenum:"",
...
//                BizOfferId:this.$route.query.id,//发布单编号
    ...
    beforeRouteEnter (to, from, next) {
      ...
      next(vm=>{
        vm.$store.commit("kaiguan",{kaiguan:true})
...
//            提交订单
      ...
      dialogBox: function () {
        ...
        if (this.buyNum == "") {
          ...
          return false
        } else if(this.receiver==""||this.receiver.replace(/(^\s*)|(\s*$)/g, "")==""){
          this.smBox = true;
