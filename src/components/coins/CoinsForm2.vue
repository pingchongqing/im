<template>
  ...
  <div id="coins" class="js-msg mt-20 bg-fff clearfix" style="margin-bottom: 1.5rem">
    ...
    <ul class="bg-fff">
      <li class="w-100 border-bottom clearfix lh110 px-30 f32 pr" v-if="IsjueseName">
      ...
      <li class="w-100 border-bottom clearfix lh110 px-30 f32 pr" v-if="IsZhanghoa">
        <span class="f32">游戏账号</span>
