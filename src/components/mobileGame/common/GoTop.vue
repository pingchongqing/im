...
<script>
    export default {
        ...
        methods: {
            ...
            goTop: function () {
                var self = this;
                if (self.$parent.$parent.$refs.app != null)
                    self.$parent.$parent.$refs.app.className = "app app-auto";
                if (!self.dom) {
                ...
                if (self.$parent.isTouch != null)
                    self.$parent.isTouch = false;
                if (self.$parent.$parent.$refs.app != null)
                    self.$parent.$parent.$refs.app.className = "app app-touch";
            }
        },
    }
</script>
