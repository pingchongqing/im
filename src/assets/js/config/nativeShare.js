...
function nativeShare(elementNode, config) {
    ...
    this.html = function () {
        var position = document.getElementById(this.elementNode);
        /*  var html = ' <a data-app="weixin" class="nativeShare"><i class="new-sharediv04"></i>微信</a>' +
         ...
         ' <a class="copybtn mt-40" onClick="Copy" id="copy" :data-clipboard-text="urlAddress"><i class="new-sharediv03"></i>复制</a>';
         position.innerHTML = html;*/
    }
